								...
								<div class="BorderClass HolderContent" <%'=shoppingCartShow()%> >
									...
									<div class="InfoContent" <%'confirmShow()%> >									
										<div class="InfoBar">
											...
											<div class="LabelBar" onclick="funClickShowHide('Orders')">Đăng nhập thành công</div>
										</div>
									</div>
									 <%  else if Request.Form("type") = "customers" and  Request.Form("actionType") = "logout" then
									%>
									<div class="InfoContent" <%'confirmShow()%> >									
										<div class="InfoBar">
											<div class="LeftBlock Icon"><span></span></div> 																
									 ...
									 <% 
										...
										session.Abandon()
										'session.Contents.Remove("dangnhap")
										end if
									end if
									%>
								</div>
