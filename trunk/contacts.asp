					...
					<div class="CenterRightSide">
					  ...
					  <div class="BorderClass Center">
							...
							<div class="BorderClass HolderContent">
								<div class="LeftBar">
									<div class="RightBar">
										<div class="TitleBar">Liên hệ với chúng tôi</div>		
									</div>
								</div>							
								
								<!-- bat dau lien he dat quang cao-->
								<div class="InfoContent">									
									<div class="InfoBar">
										<div class="LeftBlock Icon"><span></span></div>
										<div class="LabelBar" onclick="funClickShowHide('OrderAD')">Thông tin liên lạc</div>
									</div>
									<div id="OrderAD" class="OverFlowHidden">
										<ul>
											<li>www.namhai.vn</li>
											<li>Địa chỉ:</li>
											<li>Điện thoại:</li>
								...
								<!-- ket thuc lien he dat quang cao-->
							</div>
							<!--end Lien he-->	
